...
class FileParseManager {
    ...
    public function get_icon(string $path, bool $preview = false, int $size = 0):string {
        ...
        $fontExtensions = ["ttf", "otf", "woff", "woff2", "eot"]; // Шрифты
        $musicExtensions = ["mp3"]; // Музыка
